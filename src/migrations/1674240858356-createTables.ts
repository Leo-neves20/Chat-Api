...
export class createTables1674240858356 implements MigrationInterface {
    name = 'createTables1674240858356'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "friends" ("id" SERIAL NOT NULL, "userId" uuid, CONSTRAINT "PK_65e1b06a9f379ee5255054021e1" PRIMARY KEY ("id"))`);
